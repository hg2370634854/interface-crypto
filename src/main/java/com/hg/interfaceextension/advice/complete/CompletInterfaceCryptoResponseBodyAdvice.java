 ...
 */
@ControllerAdvice
public class CompletInterfaceCryptoResponseBodyAdvice implements ResponseBodyAdvice<Object> {

    private final Logger logger = LoggerFactory.getLogger(CompletInterfaceCryptoResponseBodyAdvice.class);
    /**
     * 提供加密解密的实体
     */
    @Autowired
    private CompleteCryptoManager cryptoManager;

    /**
     * 全局框架配置
     */
    @Autowired
    private CompleteInterfaceCryptoProperties controlProperties;
    ...
    public Object beforeBodyWrite(Object body, MethodParameter returnType, MediaType selectedContentType, Class selectedConverterType, ServerHttpRequest request, ServerHttpResponse response) {
        ...
        try {
            // 此时的accessKey由于被过滤器判断了，所以此时必定不为空
            ...
            String encryptStr = cryptoManager.encryptStr(dataStr, accessKey);
