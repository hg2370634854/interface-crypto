 ...
 */
@ControllerAdvice
public class SimpleInterfaceCryptoRequestBodyAdvice extends RequestBodyAdviceAdapter {

    private final Logger logger = LoggerFactory.getLogger(SimpleInterfaceCryptoRequestBodyAdvice.class);
    @Autowired
    ...
    public HttpInputMessage beforeBodyRead(HttpInputMessage inputMessage, MethodParameter parameter, Type targetType, Class<? extends HttpMessageConverter<?>> converterType) throws IOException {
        ...
        if (StringUtils.hasText(encryptStr)) {
            try {
                String decryptStr = cryptoManager.decryptStr(encryptStr, null);
